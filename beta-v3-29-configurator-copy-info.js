(() => {
  ...
  style.textContent = `
    ...
    .v326-summary .progress,.v326-summary .progress-bar,.v326-summary [role="progressbar"],.v325-composition-summary .progress,.v325-composition-summary .progress-bar,.v325-composition-summary [role="progressbar"],.v325-cart-progress,.v324-cart-progress{display:none!important}
